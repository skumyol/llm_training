...
The repository releases code, manuscript sources, figures, and evaluation artifacts; trained model checkpoints and generated data splits are available in a separate artifact bundle.
\end{abstract}
...
Trained model checkpoints and full generated data splits are available in a separate artifact bundle; the repository contains scenario definitions, evaluation code, and compact evaluation artifacts.
...
The repository contains code, paper sources, figures, and compact evaluation artifacts; trained checkpoints and full generated data splits are available in a separate artifact bundle.
...
The full merged corpora (70K+ turns) are available in a separate artifact bundle for full reproducibility.
...
All three stages have been trained and independently evaluated; the joint model is included in the released artifact bundle.
