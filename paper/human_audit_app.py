...
### Important rules
1. **Minimum time per turn: 40 seconds.** The Submit button will be blocked until you have spent at least 40 seconds on the current turn. This prevents rushed or random labeling.
...
def build_interface(data_path: str | None, output_dir: str, test_mode: bool | None = None) -> gr.Blocks:
    ...
    with gr.Blocks(title="NPC Social-State Human Audit", css=_CSS) as demo:
        ...
        # Time display — updated server-side on every interaction.
        ...
        def _toggle_local(is_active, annotator_name, output_dir_box, uploaded_file, prolific_pid_box_val):
            ...
            if not is_active:
                ...
                return (gr.update(value=session_started),) + result
            else:
