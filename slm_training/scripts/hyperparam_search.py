...
SCRIPT_DIR = Path(__file__).resolve().parent.parent  # slm_training/
...
def run_personality_trial(trial: optuna.Trial) -> float:
    ...
    try:
        ...
        summary_path = SCRIPT_DIR / "artifacts/personality_encoder" / run_id / "run_summary.json"
...
def run_affect_trial(trial: optuna.Trial) -> float:
    ...
    try:
        ...
        # Parse result
        summary_path = SCRIPT_DIR / "artifacts/affect_encoder" / run_id / "run_summary.json"
