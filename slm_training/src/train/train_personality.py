...
def run(cfg: PersonalityTrainConfig) -> None:
    ...
    for epoch in range(cfg.epochs):
        model.train()
        for batch in tqdm(train_loader, desc=f"train personality epoch {epoch+1}"):
        ...
        if val_loss < best_val:
            ...
            print(f"saved best personality encoder to {out_dir}, val_loss={val_loss:.6f}")
